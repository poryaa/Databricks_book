...
This folder defines all source code for the 'test_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_test_pipeline.py" to get familiar with the syntax.
